...
producto = [0.0, 0.0, 0.0]
producto[0] = float(input ("Precio del primer producto: "))
producto[1] = float(input ("Precio del segundo producto: "))
producto[2] = float(input ("Precio del tercer producto: "))
